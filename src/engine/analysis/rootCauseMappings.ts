// ============================================================
//  Root Cause Mappings — static lookup table that maps each rule
//  code to possible root causes + recommended actions for
//  executive investigation.
//  --------------------------------------------------------
//  Pure data — no DB calls, no side effects, no logic.
//
//  Consumed by:
//    - rootCauseEngine.ts (getRootCauses / getRootCause / listKnownRuleCodes)
//    - Re-exported via analysis/index.ts barrel
//
...
//
//  Split out from rootCauseEngine.ts (Task ID 2-b) so that
//  rootCauseEngine.ts contains only runtime logic (~80 LOC)
//  while this file holds the ~400 LOC of declarative data.
// ============================================================
