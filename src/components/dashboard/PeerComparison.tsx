...
import type { PeerRow, MetricDef, ItemComparisonResponse, TrendResponse, PeerAverages } from './peer-comparison/types';
...
import {
  ...
  computePeerAnomalyFlags,
} from './peer-computation';
import {
  EfficiencyScoreCard,
  GapAnalysisCard,
  ScatterPlotCard,
